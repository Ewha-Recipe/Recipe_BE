...
public class CommentService {
    ...
    public List<CommentDto> comments(Long food_id) {
     /*   // 1. 댓글 조회
        List<Comment> comments = commentRepository.findByFoodId(food_id);
        // 2. 엔티티 -> DTO 변환
        ...
        // 3. 결과 반환
        return commentRepository.findByFoodId(food_id)// 엔티티 목록 조회
    ...
    @Transactional
    public CommentDto create(Long food_id, CommentDto dto) {
        // 1. 게시글 조회 및 예외 발생
