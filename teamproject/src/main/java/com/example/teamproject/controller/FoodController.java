...
public class FoodController {
    ...
    public ResponseEntity<FoodResponseDto> createFood(@RequestBody FoodForm foodForm){
        ...
        // col1 필드값에 문자열을 추가
        String additionalText = "https://ewha-s3.s3.ap-northeast-2.amazonaws.com/images/"; // 추가할 문자열
        String updatedImgURL =  additionalText + foodForm.getImgURL(); // 기존 col1 값에 문자열 추가
        foodForm.setImgURL(updatedImgURL); // col1 필드값 변경
